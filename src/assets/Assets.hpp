...
namespace Assets {
   ...
   enum Meshes { SQUIRREL_M, BLOCK_M, NUT_M, DEPTH_WHEEL_M, BACKGROUND_M, DEPTH_GUAGE_MASK_1_M, DEPTH_GUAGE_MASK_2_M, 
                  SCORE_GUAGE_MASK_1_M, SCORE_GUAGE_MASK_2_M,  YOU_WON_M, YOU_LOST_M, CYLINDER_M, GOING_NUTS_M, SUN_M, NUT_COLOR_M, NUT_OUTLINE_M, ENERGY_M, POINTS_M, POWER_UP_BG_M, QUESTION_MARK_M, LEVEL_M, DEPTH_M, DEPTH_MASK_M, SCORE_MASK_M, NUMBER_M, HHAT_M, TNT_M };
