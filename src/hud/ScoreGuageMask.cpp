...
ScoreGuageMask::ScoreGuageMask() {
   this->mask1 = Assets::getMesh(Assets::SCORE_GUAGE_MASK_1_M);
   this->mask2 = Assets::getMesh(Assets::SCORE_GUAGE_MASK_2_M);
...
void ScoreGuageMask::render() {
   cshader.setMaterial(mat);
   modelTrans.useModelViewMatrix();
   modelTrans.loadIdentity();
   modelTrans.pushMatrix();

   modelTrans.translate(glm::vec3(11.0,2.55,3.0));
   ...
   modelTrans.translate(glm::vec3(10.9,-8.3,4.0));
   modelTrans.scale(2.085f,2.8f,1.0);
   //modelTrans.rotate(ang, glm::vec3(1.0, 0.0, 0.0));
   setModel();
